...
if ($info['author']){$cite='作者：'.$info['author'].'&nbsp;&nbsp;';}
if ($info['author']&&$info['homepage']){$cite='作者：<a href="'.$info['homepage'].'">'.$info['author'].'</a>&nbsp;&nbsp;';}
if ($info['version']){$cite=$cite.'版本: '.$info['version'];}
